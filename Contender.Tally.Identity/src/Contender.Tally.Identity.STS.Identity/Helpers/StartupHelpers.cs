...
using Contender.Tally.Identity.STS.Identity.Configuration;
using Contender.Tally.Identity.STS.Identity.Configuration.ApplicationParts;
using Contender.Tally.Identity.STS.Identity.Configuration.Constants;
using Contender.Tally.Identity.STS.Identity.Configuration.Interfaces;
using Contender.Tally.Identity.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Contender.Tally.Identity.STS.Identity.Helpers
{
