...
using Contender.Tally.Identity.Admin.Api.Configuration;
using Contender.Tally.Identity.Admin.Api.Configuration.Authorization;
using Contender.Tally.Identity.Admin.Api.ExceptionHandling;
using Contender.Tally.Identity.Admin.Api.Helpers;
using Contender.Tally.Identity.Admin.Api.Mappers;
using Contender.Tally.Identity.Admin.Api.Resources;
using Contender.Tally.Identity.Admin.EntityFramework.Shared.DbContexts;
using Contender.Tally.Identity.Admin.EntityFramework.Shared.Entities.Identity;
using Skoruba.IdentityServer4.Shared.Configuration.Helpers;
using Contender.Tally.Identity.Shared.Dtos;
using Contender.Tally.Identity.Shared.Dtos.Identity;

namespace Contender.Tally.Identity.Admin.Api
{
